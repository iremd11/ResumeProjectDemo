	...
	function malat_backgrounds() {
		...
		if ( $body.hasClass('slideshow-background') ) {
			$body.vegas({
				...
				slides: [
					{ src: '/templates/demo/images/image-15.jpg' },
					{ src: '/templates/demo/images/image-16.jpg' },
					{ src: '/templates/demo/images/image-10.jpg' },
					{ src: '/templates/demo/images/image-14.jpg' }
				]
			});
		}
		...
		if ( $body.hasClass('slideshow-zoom-background') ) {
			$body.vegas({
				...
				slides: [
					{ src: '/templates/demo/images/image-7.jpg' },
					{ src: '/templates/demo/images/image-16.jpg' },
					{ src: '/templates/demo/images/image-17.jpg' },
					{ src: '/templates/demo/images/image-15.jpg' }
				]
			});
		}
